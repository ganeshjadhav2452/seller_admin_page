...
submitBtn.addEventListener('click', async (e) => {
    ...
    try {
        ...
        if (obj.category == 'Electronic') {
            let postResponse = await axios.post('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/electronic', obj);
            ...
            let postResponse = await axios.post('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/skincare', obj);
            showProducts(postResponse.data)

        } else {

            let postResponse = await axios.post('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/food', obj);
            showProducts(postResponse.data)
        }
                ...
                if (response.category == 'Electronic') {
                    ...
                    if (parentOfCard) {
                        try {
                            ...
                            await axios.delete(`https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/electronic/${response._id}`)
                ...
                if (response.category == 'Skin Care') {
                    ...
                    if (parentOfCard) {
                        try {
                            ...
                            await axios.delete(`https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/skincare/${response._id}`)
                ...
                if (response.category == 'Food') {
                    ...
                    if (parentOfCard) {
                        try {
                            ...
                            await axios.delete(`https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/food/${response._id}`)
...
window.addEventListener('DOMContentLoaded', async (e) => {
    ...
    let elResponse = await axios.get('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/electronic')
    ...
    let skinResponse = await axios.get('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/skincare')
    skinResponse.data.forEach((item) => showProducts(item))

    // getting food product

    let foodResponse = await axios.get('https://crudcrud.com/api/061c2727af53472c812f528f84e4c2ab/food')
